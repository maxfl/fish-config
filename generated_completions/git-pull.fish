...
complete -c git-pull -l edit -l no-edit --description 'Invoke an editor before committing successful m… [See Man Page]'
...
complete -c git-pull -s r -l rebase --description 'Rebase the current branch on top of the upstrea… [See Man Page]'
