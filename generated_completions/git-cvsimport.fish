...
complete -c git-cvsimport -s o --description 'When no remote is specified (via -r) the HEAD b… [See Man Page]'
complete -c git-cvsimport -s i --description 'Import-only: don\\(cqt perform a checkout after importing.'
complete -c git-cvsimport -s k --description 'Kill keywords: will extract files with -kk from… [See Man Page]'
...
complete -c git-cvsimport -s M --description 'Attempt to detect merges based on the commit me… [See Man Page]'
...
complete -c git-cvsimport -s A --description 'CVS by default uses the Unix username when writ… [See Man Page]'
complete -c git-cvsimport -s R --description 'Generate a $GIT_DIR/cvs-revisions file containi… [See Man Page]'
