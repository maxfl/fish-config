...
complete -c git-svn -l 'repack[' -l repack-flags --description 'These should help keep disk usage sane for larg… [See Man Page]'
...
complete -c git-svn -s d -l destination --description '.'
...
complete -c git-svn -l repack --description '.'
