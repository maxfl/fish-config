...
complete -c certtool -l inder -l no-inder --description 'Use DER format for input certificates and private keys.'
complete -c certtool -l outder -l no-outder --description 'Use DER format for output certificates and private keys.'
