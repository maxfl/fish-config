function help --description 'Show help for the fish shell'
	...
	if count $argv >/dev/null
		switch $argv[1]
			case -h --h --he --hel --help
				...
				return 0
	        case -t --term --terminal
                set BROWSER /usr/bin/elinks
                set -e argv[1]
		end
	end
	...
	#
	set -l graphical_browsers htmlview x-www-browser firefox galeon mozilla konqueror epiphany netscape luakit chromium
